      ...
      <IonTabs>
        ...
        <IonTabBar slot="bottom">
          <IonTabButton tab="home" href="/home">
            <IonImg class="tab-icon icon-Home" src="/assets/images/ui components/empty.png"></IonImg>
            <IonLabel>Home</IonLabel>
          </IonTabButton>
          <IonTabButton tab="requests" href="/requests">
          <IonImg img-src="" class="tab-icon icon-Requests" src="/assets/images/ui components/empty.png"></IonImg>
            <IonLabel>Requests</IonLabel>
          </IonTabButton>
          <IonTabButton tab="profile" href="/profile">
          <IonImg class="tab-icon icon-Profile"  src="/assets/images/ui components/empty.png"></IonImg>
